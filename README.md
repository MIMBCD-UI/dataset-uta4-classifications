<meta http-equiv="refresh" content="0; url='https://mimbcd-ui.github.io/dataset-uta4-classifications/web/index.html'" />

# UTA4: Severity & Pathology Classifications Dataset

<img src="https://github.com/MIMBCD-UI/meta/blob/master/banners/datasets_1280x640.png?raw=true" width="100%" />

[![License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue.svg?style=flat-square)](https://github.com/MIMBCD-UI/dataset-uta4-classifications/blob/master/LICENSE)
[![Last commit](https://img.shields.io/github/last-commit/MIMBCD-UI/dataset-uta4-classifications?style=flat-square)](https://github.com/MIMBCD-UI/dataset-uta4-classifications/commits/master)
[![HitCount](http://hits.dwyl.io/MIMBCD-UI/dataset-uta4-classifications.svg)](http://hits.dwyl.io/MIMBCD-UI/dataset-uta4-classifications)
...
```bash
git clone https://github.com/MIMBCD-UI/dataset-uta4-classifications.git
```
